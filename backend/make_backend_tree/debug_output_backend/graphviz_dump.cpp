...
static filenames_for_dump filename_ctor(){
    ...
    if(snprintf(dump.dot_filename, 200, 
                "backend/make_backend_tree/debug_output_backend/images/dump%d_%04d%02d%02d_%02d%02d%02d.dot", num,
    ...
    if(snprintf(dump.svg_filename, 200, 
                "backend/make_backend_tree/debug_output_backend/images/dump%d_%04d%02d%02d_%02d%02d%02d.svg", num,
                t->tm_year + 1900, t->tm_mon + 1, t->tm_mday,
                t->tm_hour, t->tm_min, t->tm_sec) == -1) {
