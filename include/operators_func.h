...
const op_info OPERATORS_INFO[] = {
    ...
    {OP_GEQ,         "сazzo_medio_o_lungo",     sizeof("сazzo_medio_o_lungo")     - 1,  ">=",     "OP_GEQ",   SHIFT_RBP(CalculRpbShiftOther,)      TRASLATE(CreateGeqAsm)},
    {OP_LEQ,         "cazzo_medio_o_piu_corto", sizeof("cazzo_medio_o_piu_corto") - 1,  "<=",     "OP_LEQ",   SHIFT_RBP(CalculRpbShiftOther,)      TRASLATE(CreateLeqAsm)},
    ...
    {OP_OPEN_BR,     "(Ciucciami",              sizeof("(Ciucciami")              - 1,  "(",      "OP_OB",    SHIFT_RBP(CalculRpbShiftOther,)      TRASLATE(CreateOpenBrAsm)},
